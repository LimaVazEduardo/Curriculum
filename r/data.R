...
qualific <- tribble(
  ...
  "Studing R, Rmd and Data Science."
)
...
eldorado <- tribble(
  ~company, ~job, ~date, ~desc,
  "Instituto de Pesquisas Eldorado", "Senior Software Engineer", "2015-2010", "Worked on a end to end project aimed to transfer Android certification process (Radio-Frequency, Safety and Radiation Absorption) from Motorola US to Lenovo headquarters in Asia."
)
